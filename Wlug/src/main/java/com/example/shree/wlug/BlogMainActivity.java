...
public class BlogMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Please wait loading Blog..",Toast.LENGTH_LONG).show();
        ...
        mBlogList.addOnItemTouchListener(
                new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        Toast.makeText(BlogMainActivity.this,"THis is click",Toast.LENGTH_LONG).show();
                        Log.d("click","******************");
                        ...
                        Intent intent;
                        intent = new Intent(BlogMainActivity.this,ExpandedBlog.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            startActivity(new Intent(BlogMainActivity.this,BlogPostActivity.class));
        }
